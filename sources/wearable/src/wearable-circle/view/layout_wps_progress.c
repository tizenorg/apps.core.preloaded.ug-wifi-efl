...
static Eina_Bool __progress_timer_task_cb(void *data)
{
	...
	wps_progress->progress_percent_text = percent_text;
	elm_object_part_text_set(wps_progress->progress_popup_layout, "elm.swallow.percent_text", wps_progress->progress_percent_text);
